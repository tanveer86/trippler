        ...
        <React.Fragment>
            <div class="container-fuild">
                <div class="row text-center mt-5">
                    ...
                    <h2 class="text-center mb-4">Now Compare and Buy Wine at Lowest Price From Local Bars Near You</h2>
                    </div>
                    <div class="col-4">
                        <img src="https://www.dunzo.com/_next/static/images/feature2-b342ae46dfef9f0813407befb027f29c.png" width="100"/>
                        <h3 class="mt-3">Delivered in 60 Minutes</h3>
                    ...
                    <div class="col-4">
                        ...
                        <h3 class="mt-3">No Minimum Order</h3>
                    ...
                    <div class="col-4">
                        ...
                        <p>All the orders at Trippler will be delivered for free.</p>
                    </div>
                </div>
            </div>
        </React.Fragment>
